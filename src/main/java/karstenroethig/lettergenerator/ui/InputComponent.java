...
public class InputComponent extends JComponent
{
	...
	private JPanel createSenderPanel()
	{
		...
		panel.setBorder( new CompoundBorder( new TitledBorder( null, "Absender", TitledBorder.LEFT, TitledBorder.TOP ), null ) );
		...
		addComp( panel, createTextField( "senderName" ), 1, 0, 1, 1, 1, 0, GridBagConstraints.NORTHWEST, GridBagConstraints.HORIZONTAL );
		addComp( panel, createTextField( "senderStreet" ), 1, 1, 1, 1, 1, 0, GridBagConstraints.NORTHWEST, GridBagConstraints.HORIZONTAL );
		addComp( panel, createTextField( "senderPostcode" ), 1, 2, 1, 1, 0, 0, GridBagConstraints.NORTHWEST, GridBagConstraints.HORIZONTAL );
		addComp( panel, createTextField( "senderCity" ), 1, 3, 1, 1, 0, 0, GridBagConstraints.NORTHWEST, GridBagConstraints.HORIZONTAL );
	...
	private JPanel createAddresseePanel()
	{
		...
		panel.setBorder( new CompoundBorder( new TitledBorder( null, "Empfänger", TitledBorder.LEFT, TitledBorder.TOP ), null ) );
	...
	private JPanel createContentPanel()
	{
		...
		panel.setBorder( new CompoundBorder( new TitledBorder( null, "Schreiben", TitledBorder.LEFT, TitledBorder.TOP ), null ) );
		...
		addComp( panel, createTextField( "formattedDate" ), 1, 0, 1, 1, 1, 0, GridBagConstraints.NORTHWEST, GridBagConstraints.HORIZONTAL );
		addComp( panel, createTextField( "summary" ), 1, 1, 1, 1, 1, 0, GridBagConstraints.NORTHWEST, GridBagConstraints.HORIZONTAL );
		addComp( panel, createTextAreaWithScrollPane( "text" ), 1, 2, 1, 1, 1, 1, GridBagConstraints.NORTHWEST, GridBagConstraints.BOTH );
	...
	private JPanel createOptionsPanel()
	{
		...
		panel.setBorder( new CompoundBorder( new TitledBorder( null, "Optionen", TitledBorder.LEFT, TitledBorder.TOP ), null ) );
